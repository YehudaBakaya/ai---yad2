    ...
    <div className="min-h-screen bg-slate-900 pt-8 pb-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-extrabold text-white">המועדפים שלי</h1>
            <p className="text-gray-400 text-sm">{favoritesList.length} מודעות שמורות</p>
          </div>
        </div>
        ...
        {favoritesList.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <h2 className="text-white font-bold text-lg mb-2">אין מועדפים עדיין</h2>
            <p className="text-gray-500 text-sm max-w-xs">
              לחץ על הלב בכל מודעה כדי לשמור אותה כאן
            </p>
          </div>
        ) : (
